...
class Musica(models.Model):
    ...
    album = models.ForeignKey('Album', on_delete=models.CASCADE, related_name='musicas',default = 1)
...
class Album(models.Model):
    titulo = models.CharField(max_length=100)
    banda = models.ForeignKey('Banda', on_delete=models.CASCADE, related_name='albuns',default = 1)
